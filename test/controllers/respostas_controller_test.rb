...
class RespostasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resposta" do
    assert_difference('Resposta.count') do
      post respostas_url, params: { resposta: { pergunta_id: @resposta.pergunta_id, resposta: @resposta.resposta } }
    end
  ...
  test "should update resposta" do
    patch resposta_url(@resposta), params: { resposta: { pergunta_id: @resposta.pergunta_id, resposta: @resposta.resposta } }
